...
$data = $obpp->getUserSingleService($_SESSION['user']['user_id'],$_GET['service_id']);
$count = $data->rowCount();
if ($count == 0) {
...
<body>
    ...
    <div class="container page-body d-flex justify-content-center align-items-center">
        <div class="col-md-12 py-3 pb-3 form-signup my-5 mb-5">
            ...
            <form method="post" action="./controller/post.controller?action=updateService" class="row g-3 needs-validation" id="addServiceForm" novalidate enctype="multipart/form-data">
                ...
                <div class="col-12">
                    ...
                    $i=0;
                        ...
                        <div class="form-check ms-5 ps-5">
                            <input class="form-check-input " type="radio" name="service_type" id="flexRadioDefault1" value="<?php echo $rp['stype_id'] ?>"  <?php if($rp['stype_id']==$post['stype_id']){echo 'checked';} ?>>
